...
public class CourseTest {
	...
	@Before
	public void runBefore() throws IllegalSectionInitialization {
	...
	@Test
	public void testTwoCoursesEqual() throws IllegalSectionInitialization {
	...
	@Test
	public void testTwoCoursesNotEqual() throws IllegalSectionInitialization {
		Course course210another = new Course("CPSC", 210);
		course210another.addSection(new Section("201", "MWF", "12:00", "12:50", new Building("I", new LatLon())));
	...
	@Test
	public void testIsSectionInList() throws IllegalSectionInitialization{
		/// TODO
		Course course210another = new Course("CPSC", 210);
		Section section201 = new Section("201", "MWF", "12:00", "12:50", new Building("I", new LatLon()));
		Section section202 = new Section("202", "MWF", "13:00", "13:50", new Building("J", new LatLon()));
		course210another.addSection(section201);
		
		assertTrue(course210another.isSectionInList(section201));
		assertFalse(course210another.isSectionInList(section202));
	}
}
